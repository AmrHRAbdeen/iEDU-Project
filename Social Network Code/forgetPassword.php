...
if(isset($_POST["e"])){
	...
	if($numrows > 0){
	    ...
	    $query = mysqli_query($link, $sql);
		$to = "$e";
		$from = "auto_responder@iedu-eg.com";
		$headers ="From: $from\n";
		$headers .= "MIME-Version: 1.0\n";
		$headers .= "Content-type: text/html; charset=iso-8859-1 \n";
		$subject ="iEDU.com Temporary Password";
		$msg = '<h2>Hello '.$u.'</h2><p>This is an automated message from iedu-eg.com. If you did not recently initiate the Forgot Password process, please disregard this email.</p><p>You indicated that you forgot your login password. We can generate a temporary password for you to log in with, then once logged in you can change your password to anything you like.</p><p>After you click the link below your password to login will be:
		<br /><b>'.$tempPass.'</b></p><p><a href="http://www.iedu-eg.com/00SN/forgetPassword.php?u='.$u.'&p='.$hashTempPass.'">Click here now to apply the temporary password shown below to your account</a></p><p>If you do not click the link in this email, no changes will be made to your account. In order to set your login password to the temporary password you must click the link above.</p>';
...
function forgotpass(){
	...
	if(e == ""){
		...
		var ajax = ajaxObj("POST", "forgetPassword.php");
