...
<html>
<head>
	<title><?php echo $_SESSION['firstname']. " " . $_SESSION['lastname'] . ""; ?> Profile</title>
	...
	<div id="sidebar-wrapper" style="background-color:white;border-right: 1px solid #e5e5e5;">
        ...
        <div id="page-content-wrapper">
              <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                         <a style="float:left;" href="//www.profesaulosuna.com/data/files/ELECTRONICA/CIRCUITOS%20MECATRONICOS/The.Mechatronics.Handbook.pdf"><img src="booksImages/Mechatronics_Handbook.jpg" width="130px" height="200px"/></a>                       
                    	 <a style="float:left;" href="http://siva.bgk.uni-obuda.hu/~szakacs/segedanyagok/0708/SansC/Modern%20Control%20Engineering%205th%20Edition.pdf"><img src="booksImages/Modern control.PNG" width="230px" height="300px"/></a> 
                    </div>
