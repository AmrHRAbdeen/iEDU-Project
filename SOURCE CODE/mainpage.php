...
if (!$_SESSION['id']) header("location:index.php?u=".$_SESSION['username']);
	...
	<div id="sidebar-wrapper" style="background-color:white;border-right: 1px solid #e5e5e5">
            <ul class="sidebar-nav">
                ...
                <li style="color:#707070;">
                 ...
                 <li style="color:#707070;">
                    <a href="jobs.php" style="color:black;"><span class="glyphicon glyphicon-briefcase" style="padding-right:5px;color:#707070 !important;"></span>Jobs</a>
                </li>
        ...
        <div id="page-content-wrapper">
              <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    	<!-- Youtube Arduino Series -->
                        <iframe width="360" height="260" src="https://www.youtube.com/embed/HkPIaMGjKts" frameborder="0" allowfullscreen></iframe>
